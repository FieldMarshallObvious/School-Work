...
int BinarySearchTree::deleteElement( int value, int loc )
{
    ...
    if( array[loc] != NULL )
    {
        ...
        else
        {
            ...
            array[( loc * 2 ) + 2] = deleteElement( array[temp],
                                                                ( loc * 2 )
                                                                 + 2);
        }
    }
...
{
    // Variable declarations
    int sum = 0,     // Holds the sum of all the leaves
    curNode = 0;    // Startiting posistion
    // in the array
...
//**************************************************
//  Creates the correct size of the binary
//  tree based on the inputted size.
//
//  x - Holds the desired size
//**************************************************
