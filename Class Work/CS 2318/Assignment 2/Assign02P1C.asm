...
# (from 1st to 4th element) becomes 2, 3, 1 and 8, using the following 
# operations in the order listed (to not defeat the goals of this exercise, you
# must NOT change the specified operations and order, even if  doing so will
# accomplish the same effect more efficiently):
